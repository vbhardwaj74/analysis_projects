...
app = JupyterDash(__name__, external_stylesheets=[
        'https://codepen.io/chriddyp/pen/bWLwgP.css'], suppress_callback_exceptions=True)
...
page_1_layout = html.Div([
    html.Div([
        ...
        dcc.Dropdown(id='page-1-dropdown_d1', options=[{'label':x, 'value':x} for x in df2.sort_values('mobile_devices')['mobile_devices'].unique()], 
                     value=None, multi=True),
        html.Label('source'),
        dcc.Dropdown(id='page-1-dropdown_d2', options=[{'label': i, 'value': i} for i in df2.sort_values('mobile_devices')["source"].unique()],
                     value=None, multi=True)
    ]),
    html.Div(id='page-1-dropdowns'),
    html.Div(id="page-1-final_table", className="six columns"),
    html.Div([
        html.Div([
            dcc.Graph(id='page-1-line_chart'),
...
@app.callback([
    Output('page-1-final_table','children'),
    Output('page-1-line_chart', 'figure')],
    [Input('page-1-dropdown_d1', 'value'),
     Input('page-1-dropdown_d2', 'value')])
...
page_2_layout = html.Div([
    html.Div([
        html.Label('mobile devices'),
        dcc.Dropdown(id='page-2-dropdown_d1', options=[{'label':x, 'value':x} for x in df2.sort_values('mobile_devices')['mobile_devices'].unique()], 
                     value=None, multi=True),
        html.Label('source'),
        dcc.Dropdown(id='page-2-dropdown_d2', options=[{'label': i, 'value': i} for i in df2.sort_values('mobile_devices')["source"].unique()],
                     value=None, multi=True)
    ]),
    html.Div('page-2-dropdowns'),
    html.Div(id="page-2-final_table", className="six columns"),
    html.Div([
        html.Div([
            dcc.Graph(id='page-2-line_chart'),
        ],className="six columns"),
        html.Div([
            dcc.RangeSlider(
                id="rangeslider",
...
@app.callback([
    Output('page-2-final_table','children'),
    Output('page-2-line_chart', 'figure')],
    [Input('page-2-dropdown_d1', 'value'),
     Input('page-2-dropdown_d2', 'value')])
